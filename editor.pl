...
#$cui->set_binding($cui->toggle_readonly, "\cT");
#$cui->set_binding($cui->search, "\cF");
#$cui->set_routine('search'  , $cui->search);
#$cui->set_binding('search-forward'  , '\cF');
